package isv.sap.payment.addon.controllers.pages.checkout;
...
public class CheckoutController extends AbstractCheckoutController
{
            ...
            throws CMSItemNotFoundException
    {
        ...
        if(orderFacade.getOrderDetailsForGUID(orderCode).isGuestCustomer())
        {
            return processOrderCode(orderCode, model);
        }
        String orderGUIDCode = orderFacade.getOrderDetailsForGUID(orderCode).getCode();
        
        return processOrderCode(orderGUIDCode, model);
    }
            ...
            final RedirectAttributes redirectModel) throws CMSItemNotFoundException
    {
        ...
        try
        {
            ...
            getAutoLoginStrategy()
                    .login(getCustomerFacade().getCurrentCustomer().getUid(), form.getPwd(), request, response);
    ...
    protected String processOrderCode(final String orderCode, final Model model) throws CMSItemNotFoundException
    {
        ...
        return "addon:/isvpaymentaddon/pages/checkout/checkoutConfirmationLayoutPage";
    }
    ...
    protected void processEmailAddress(final Model model, final OrderData orderDetails)
    {
        ...
        if (orderDetails.isGuestCustomer() && !model.containsAttribute("guestRegisterForm"))
        {
            ...
            uid = orderDetails.getBillingAddress().getEmail();
