...
public class IdealSaleRequester extends SofortSaleRequester
{
    @Override
            ...
            final Map<String, Object> optionalParams)
    {
        ...
        final Object optionId = optionalParams.get(
                IsvPaymentAddonConstants.AlternativePayments.PAYMENT_OPTION_ID);
        if (optionId != null)
        {
            saleBuilder.setPaymentOptionID((String) optionId);
        }
    ...
    {
        return paymentType.equals(AlternativePaymentMethod.IDL);
    }
}
