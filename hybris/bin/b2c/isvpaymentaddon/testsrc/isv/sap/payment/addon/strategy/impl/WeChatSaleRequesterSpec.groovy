...
@UnitTest
class WeChatSaleRequesterSpec extends AbstractSaleRequesterSpec
{
    @Override
    AbstractSaleRequester createRequester()
    {
        new WeChatSaleRequester()
    }
    ...
    def assertRequest(request, cart, type)
    {
        ...
        assert request.requestParams['apSaleServiceTransactionTimeout'] == '360'
