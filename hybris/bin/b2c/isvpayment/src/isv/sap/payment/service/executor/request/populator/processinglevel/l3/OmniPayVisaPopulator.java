...
import static isv.cjl.payment.constants.PaymentRequestParamConstants.OTHER_TAX_VAT_TAX_RATE;
import static isv.cjl.payment.constants.PaymentRequestParamConstants.PURCHASE_TOTALS_FREIGHT_AMOUNT;
...
/**
 * Component that encapsulates 3rd processing level data population for Visa and OmniPay Direct processor.
 * <p>
...
public class OmniPayVisaPopulator extends AbstractOmniPayPopulator
{
    ...
    protected void populateOrderData(final AbstractOrderModel order, final PaymentTransaction target)
    {
        ...
        target
                ...
                .addParam(PURCHASE_TOTALS_FREIGHT_AMOUNT, ZERO)
                .addParam(OTHER_TAX_VAT_TAX_RATE, valueOf(0.001))
