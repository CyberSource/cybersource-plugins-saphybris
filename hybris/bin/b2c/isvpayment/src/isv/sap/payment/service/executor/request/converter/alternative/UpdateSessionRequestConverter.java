...
public class UpdateSessionRequestConverter extends AbstractRequestConverter
{
    ...
    public Request convert(final PaymentServiceRequest source)
    {
        ...
        addOptionalFields(target, source, cart);
    ...
    protected void addOptionalFields(final PaymentTransaction target, final PaymentServiceRequest source, final AbstractOrderModel cart)
    {
        target.addParam(PURCHASE_TOTALS_DISCOUNT_AMOUNT, valueOf(cart.getTotalDiscounts()))
