...
class DiscoverMerchDecryptionStrategySpec extends Specification
{
    def source = PaymentServiceRequest.create()

    def strategy = new DiscoverMerchDecryptionStrategy()
    ...
    def 'should convert source to request using merchant decryption'()
    {
        ...
        source.addParam('cardType', CardType.DISCOVER)
        ...
        requestFields.cardType == CardType.DISCOVER
        requestFields.ccAuthServiceCavv == 'Amp3UzwACqPVG1/lbibCMAABAAA='
        requestFields.ccAuthServiceCommerceIndicator == PaymentConstants.ApplePay.Authorization.DISCOVER_COMMERCE_INDICATOR
