...
import isv.cjl.payment.service.executor.request.builder.visacheckout.AuthorizationReversalRequestBuilder
    ...
    "should receive reject for invalid visa checkout order id"()
    {
        ...
        with(result.getData('transaction')) {
            ...
            with(properties) {
                ...
                invalidField == '[(authorization_code)]'
                missingField == '[]'
