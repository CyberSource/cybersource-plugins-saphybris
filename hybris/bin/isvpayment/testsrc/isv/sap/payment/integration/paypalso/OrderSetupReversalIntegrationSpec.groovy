...
import isv.cjl.payment.service.executor.request.builder.paypalso.OrderSetupReversalRequestBuilder
...
@ManualTest
class OrderSetupReversalIntegrationSpec extends IsvIntegrationSpec
{

    def builder = new OrderSetupReversalRequestBuilder()
    ...
    'should receive reject for invalid paypal order id'()
    {
        ...
        def request = builder
                ...
                .addParam(TRANSACTION, orderSetupTransaction)
                .build()
        ...
        with(result.getData('transaction')) {
            ...
            type == PaymentTransactionType.ORDER_SETUP_REVERSAL
