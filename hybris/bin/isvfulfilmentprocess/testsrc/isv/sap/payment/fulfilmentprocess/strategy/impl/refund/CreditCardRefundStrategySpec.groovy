...
@UnitTest
class CreditCardRefundStrategySpec extends Specification
{
    def paymentTransactionService = Mock(PaymentTransactionService)

    def strategy = new CreditCardRefundStrategy(paymentTransactionService: paymentTransactionService)
    ...
    @Test
    def 'should create credit card refund request'()
    {
        given:
        ...
        then:
        refundRequest.paymentType == PaymentType.CREDIT_CARD
