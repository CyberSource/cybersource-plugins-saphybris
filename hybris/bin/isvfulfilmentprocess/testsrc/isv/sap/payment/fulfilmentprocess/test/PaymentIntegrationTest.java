...
public class PaymentIntegrationTest extends ServicelayerTest
{
    ...
    public static void prepare() throws Exception //NOPMD
    {
        ...
        xmlReader.loadBeanDefinitions(new ClassPathResource(
                "/isvfulfilmentprocess/test/isvfulfilmentprocess-spring-test.xml"));
        xmlReader.loadBeanDefinitions(new ClassPathResource(
                "/isvfulfilmentprocess/test/isvfulfilmentprocess-spring-test-fraudcheck.xml"));
        xmlReader
                .loadBeanDefinitions(
                        new ClassPathResource("/isvfulfilmentprocess/test/process/order-process-spring.xml"));
    ...
    public static void removeProcessDefinitions()
    {
        ...
        final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
        xmlReader.loadBeanDefinitions(new ClassPathResource(
                "/isvfulfilmentprocess/test/isvfulfilmentprocess-spring-testcleanup.xml"));
    ...
    public void setUpProductCatalogue()
    {
        try
        {
            ...
            importCsv("/isvfulfilmentprocess/test/testBasics.csv", "windows-1252");
            importCsv("/isvfulfilmentprocess/test/testCatalog.csv", "windows-1252");
    ...
    public void testPaymentIntegrationAccepted() throws InterruptedException, CalculationException
    {
        try
        {
            ...
            assertStep("checkOrder");
            assertStep("checkAuthorizeOrderPayment");
            assertStep("cancelOrder");
            assertStep("notifyCustomer");
        }
    ...
    protected void assertStep(final String bean) throws InterruptedException
    {
