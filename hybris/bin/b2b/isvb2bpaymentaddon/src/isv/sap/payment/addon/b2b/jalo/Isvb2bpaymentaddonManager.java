...
/**
 * This is the extension manager of the Isvb2bpaymentaddon extension.
 */
public class Isvb2bpaymentaddonManager extends GeneratedIsvb2bpaymentaddonManager
{
    private static final Logger LOG = LoggerFactory.getLogger(Isvb2bpaymentaddonManager.class.getName());
     ...
     */
    public Isvb2bpaymentaddonManager()
    {
        if (LOG.isDebugEnabled())
        {
            LOG.debug("constructor of Isvb2bpaymentaddonManager called.");
        }
    }
     ...
     */
    public static Isvb2bpaymentaddonManager getInstance()
    {
        return (Isvb2bpaymentaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
                .getExtension(
                        Isvb2bpaymentaddonConstants.EXTENSIONNAME);
    }
    ...
    public void init()
    {
        if (LOG.isDebugEnabled())
        {
            LOG.debug("init() of Isvb2bpaymentaddonManager called. {}", getTenant().getTenantID());
        }
    }
    ...
    public void destroy()
    {
        if (LOG.isDebugEnabled())
        {
            LOG.debug("destroy() of Isvb2bpaymentaddonManager called, current tenant: {}", getTenant()
                    .getTenantID());
        }
    }
