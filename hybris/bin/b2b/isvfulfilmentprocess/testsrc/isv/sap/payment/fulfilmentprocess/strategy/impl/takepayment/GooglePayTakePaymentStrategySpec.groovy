...
@UnitTest
class GooglePayTakePaymentStrategySpec extends Specification
{
    def paymentTransactionService = Mock(PaymentTransactionService)

    def strategy = new GooglePayTakePaymentStrategy(paymentTransactionService: paymentTransactionService)
    ...
    @Test
    def 'should create google pay capture request without processing level data'()
    {
        given:
        ...
        then:
        capture.paymentType == PaymentType.GOOGLE_PAY
