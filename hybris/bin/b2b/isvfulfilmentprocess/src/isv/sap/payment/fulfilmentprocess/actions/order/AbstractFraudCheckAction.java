...
public abstract class AbstractFraudCheckAction<T extends OrderProcessModel> extends AbstractOrderAction<T>
{
    ...
    protected OrderHistoryEntryModel createHistoryLog(final String providerName, final OrderModel order,
            ...
            final String code)
    {
        ...
        {
            description =
                    "Fraud check [" + providerName + "]: " + status.toString() + ". Check the fraud report :" + code;
        }
    ...
    @Override
    public final String execute(final T process) throws RetryLaterException, Exception // NOPMD
    {
     ...
     * @throws Exception
     */
    public abstract Transition executeAction(T process) throws RetryLaterException, Exception; // NOPMD
