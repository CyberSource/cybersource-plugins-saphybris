...
/**
 * Generated class for type <code>IsvfulfilmentprocessManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedIsvfulfilmentprocessManager extends Extension
{
	...
	{
		return (Boolean)item.getProperty( ctx, IsvfulfilmentprocessConstants.Attributes.ConsignmentProcess.DONE);
	}
	...
	{
		item.setProperty(ctx, IsvfulfilmentprocessConstants.Attributes.ConsignmentProcess.DONE,value);
	}
	...
	{
		return IsvfulfilmentprocessConstants.EXTENSIONNAME;
	}
	...
	{
		return (Boolean)item.getProperty( ctx, IsvfulfilmentprocessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT);
	}
	...
	{
		item.setProperty(ctx, IsvfulfilmentprocessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT,value);
	}
	...
	{
		return (EnumerationValue)item.getProperty( ctx, IsvfulfilmentprocessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE);
	}
	...
	{
		item.setProperty(ctx, IsvfulfilmentprocessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE,value);
	}
